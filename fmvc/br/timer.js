...
setInterval(function save(){localStorage.setItem('timeLeft','timeLeft');},1000);function formatTime(time){const minutes=Math.floor(time/60);let seconds=time%60;if(seconds<10){seconds=`0${seconds}`;}
